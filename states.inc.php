...
$machinestates = array(
    ...
    STATE_MONSTER_PHASE => array(
        ...
        "descriptionmyturn" => clienttranslate('Monster phase : ${you} must defeat all monsters (one type of Monster at a time)'),
        "type" => "activeplayer",
        "args" => "argGenericPhasePlayerTurn",
    ...
    STATE_DRAGON_PHASE => array(
        ...
        "descriptionmyturn" => clienttranslate('Dragon phase : ${you} must defeat the Dragon (${nbr} Companions of differents types are required)'),
        "type" => "activeplayer",
